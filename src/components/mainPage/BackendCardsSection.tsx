...
const BackendTechCardsSection: React.FunctionComponent = () => {
  return (
    <section className="block m-auto my-[180px] mx-[60px] transition-all duration-500 mobile-lg:block mobile-lg:my-[60px] tablet-sm:my-[120px] tablet-lg:mx-[32px] tablet-lg:my-[140px] desktop-sm:mx-[40px]">
      <h1 id="backend" className="text-center text-[40px] font-[600] text-[--main-light] uppercase mobile-lg:text-[18px] tablet-sm:text-[20px] tablet-lg:text-[28px] desktop-lg:text-[34px]">
