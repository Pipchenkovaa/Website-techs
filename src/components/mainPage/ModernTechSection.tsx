...
const ModernTechBlock: React.FunctionComponent<ModernTechPropsType> = ({
  ...
  return (
    <section className="flex justify-between items-center my-[180px] mx-[60px] transition-all duration-500 mobile-lg:block mobile-lg:my-[60px] tablet-sm:my-[120px] tablet-lg:mx-[32px] tablet-lg:my-[140px] desktop-sm:mx-[40px]">
